"""
Django settings for anothersite project.
...
SECRET_KEY = 'django-insecure-ydii3^1#8*$cjv@c!i2c*s48gg4cs)*b0%$8d7pm(n1@1av=p_'
...
WSGI_APPLICATION = 'anothersite.wsgi.application'
...
CACHES = {
    'default': {
     # балванчик который позволяет указывать кеширование в функциях, но ничего не хранит   'BACKEND': 'django.core.cache.backends.dummy.DummyCache',
